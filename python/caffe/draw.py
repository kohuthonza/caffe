...
def get_edge_label(layer):
    ...
    elif layer.type == 'Convolution' or layer.type == "BinaryConvolution" or layer.type == 'Deconvolution':
...
def get_layer_label(layer, rankdir):
    ...
    if layer.type == 'Convolution' or layer.type == "BinaryConvolution" or layer.type == 'Deconvolution':
